...
ROLE_GROUPS = [
    ...
    ("Senior", ["Souley Wally", "Boubacar Aidara", "Cherif FAYE", "Babacar FALL",
        "Ousmane NDIAYE", "Sory CAMARA", "Koulou DANSOKHO", "Jacque KONE", "Malick Sy"]),
    ("Responsable base de données", ["Mame Diarra Mbaye", "Thioro TANOR", "Thierno BA"]),
    ("Responsable laboratoire", ["Fatou Gueye"]),
    ("Géochimiste", ["Babacar SARR", "Marieme Thiam", "Khardiata Paye",
